...
这本目前还只有中文版本，在未来我会继续撰写英文版本。我将来自书籍、课程、博客中的示例图按照我个人风格重新绘制并放进笔记中。笔记里的内容大多为算法理论、数学推导，由于本人非数学专业出身，因此公式符号使用和推导过程未必规范严谨。如果有发现笔记中的错误内容，还请多多包涵和指教，我希望能和大家一起学习进步。
...
- 2022.09.06 添加机器学习监督学习部分更新至“支持向量机”
